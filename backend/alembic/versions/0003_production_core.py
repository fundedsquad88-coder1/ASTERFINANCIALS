...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("bonus_rate", sa.Numeric(8,4), nullable=False),
        sa.Column("pending_bonus", sa.Numeric(28,8), nullable=False),
        sa.Column("paid_bonus", sa.Numeric(28,8), nullable=False),

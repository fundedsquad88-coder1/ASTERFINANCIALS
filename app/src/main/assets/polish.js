(function(){
  ...
  .market{position:relative;padding:15px 4px;border-bottom:1px solid rgba(255,255,255,.055);align-items:center}.market:before{content:"";width:38px;height:38px;margin-right:11px;flex:0 0 38px;border-radius:50%;background:radial-gradient(circle at 35% 30%,#fff5c7,#d5a83f 42%,#6d5017 100%);box-shadow:0 0 0 1px rgba(232,189,80,.2)}.market>span:first-child{display:block;flex:1}.market>span:first-child:before{content:""}.market small{font-size:10px}.market .status,.market .muted{font-size:9px;letter-spacing:.5px}
